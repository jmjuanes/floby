...
var file = function(obj, opt)
{
  ...
  this.cwd = (typeof opt.cwd === 'string') ? opt.cwd : process.cwd();
  ...
  //Save the file path
  this.path = path.resolve(this.cwd, path.format(obj));
...
file.prototype.read = function(cb)
{
  ...
  //Read the file
  return fs.readFile(this._path, this.encoding, function(error, data)
  {
    //Check for error
...
{
  //Get the file content
  var data = fs.readFileSync(this._path, this.encoding);
...
file.prototype.write = function(data, cb)
{
  ...
  //Write the file
  return fs.writeFile(this._path, data, this.encoding, cb);
};
...
file.prototype.writeSync = function(data)
{
  ...
  //Write the file
  fs.writeFileSync(this._path, data, this.encoding);
...
{
  //Empty the file
  return fs.writeFile(this._path, '', this.encoding, cb);
};
...
{
  //Empty the file
  fs.writeFileSync(this._path, '', this.encoding);
...
{
  //Append to the file
  return fs.appendFile(this._path, data, this.encoding, cb);
};
...
file.prototype.appendSync = function(data)
{
  ...
  fs.appendFileSync(this._path, data, this.encoding);
